...
Ya que para age ya hemos visto que tenemos bastante dispersos las edades y mejor agruparlas por los clasicos rangos de edad. Con la distancia nos pasa algo similar.
...
# Con esta funcion prcomp podemos estandarizar las variables y hacer que la
# desviacion estandar sea 1 con el parametro scale=TRUE
...
# Mientras que rotation contiene el valor de los loadings ϕ para cada componente
...
```
Arriba vemos que solo 3 de todas las variables combinadas son significativas para el modelo, de ahi el bajo $R^2$ obtenido.
...
Ni siquiera aplicando PCR logramos una gran mejora, porque si bien logramos bajar el mean squared error respecto al modelo con todas las variables. No es un disminucion muy significativa. 
...
Si bien no hemos logrado llegar a un modelo de regresion lineal que ajuste bien a los datos, hemos podido identificar varios puntos que nos servirian para una segunda iteracion de este trabajo como ser:
...
El codigo para generar este PDF fue realizado en R Markdown, el cual puede ser encontrado en el siguiente repositorio github:

[Absenteeism at work cleaning code](https://github.com/PythonGreen/absenteeism_at_work_cleaning/blob/main/code/pablodelgado-PRAC2.Rmd)
